...
function findMYM(themeinput, regioninput) {
	...
	if(((themeinput >= 25) && (themeinput <= 32)) || (themeinput == 52) || (themeinput == 129)) {
		let region = null;
